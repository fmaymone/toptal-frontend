...
const AsyncCompany = MyLoadable({ loader: () => import('../pages/Trips/Trip') })
const AsyncCompanies = MyLoadable({ loader: () => import('../pages/Trips/Trips') }, [AsyncCompany])
...
const routes = [
  ...
  <RestrictedRoute type="private" path="/trips" exact component={AsyncCompanies} />,
  <RestrictedRoute type="private" path="/trips/edit/:uid" exact component={AsyncCompany} />,
  <RestrictedRoute type="private" path="/trips/create" exact component={AsyncCompany} />,
