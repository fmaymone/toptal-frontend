...
const messages = defineMessages({
  ...
  error: 'Fehler!',
  trips: 'Unternehmen',
  create_trip: 'Unternehmen erstellen',
  edit_trip: 'Unternehmen bearbeiten',
  ...
  start_date_label: 'UID',
  start_date_hint: 'UID eingeben',
  comment_label: 'Beschreibung',
  comment_hint: 'Beschreibung eingeben',
  name_label: 'Name',
